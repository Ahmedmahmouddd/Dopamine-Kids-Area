...
class AppTextStyles {
  ...
  static const TextStyle font12BlackMedium = TextStyle(
    fontFamily: _fontFamily,
    fontSize: 12,
    fontWeight: FontWeight.w500,
  ...
  static const TextStyle font12RedSemiBold = TextStyle(
    fontFamily: _fontFamily,
    fontSize: 12,
  ...
  static const TextStyle font15GreyRegular = TextStyle(
    fontFamily: _fontFamily,
    fontSize: 15,
    fontWeight: FontWeight.w400,
    color: AppColors.grey,
  ...
  static const TextStyle font18BlackBold = TextStyle(
    fontFamily: _fontFamily,
    fontSize: 18,
    fontWeight: FontWeight.w700,
    color: AppColors.black,
  ...
  static const TextStyle font20RedBold = TextStyle(
    fontFamily: _fontFamily,
    fontSize: 20,
    fontWeight: FontWeight.bold,
    color: AppColors.red,
